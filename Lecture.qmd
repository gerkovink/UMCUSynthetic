...
4.  Missing data
5.  Synthetic data
6.  synthetic data generation with mice
...
::: notepaper
<figure class="quote"><blockquote class="curly-quotes" cite="https://www.youtube.com/watch?v=qYLrc9hy0t0"><font color="black"> Statistical inference is the process of drawing conclusions from truths </font></blockquote>
</figure>
:::
...
Rubin (1987, p76)[^1] defined the following rules:
...
The total variance $T$ of $(Q-\bar{Q})$ should [^1] equal

$$T = \bar{U} + B/m.$$

[^1]: Reiter, J.P. (2003). Inference for Partially Synthetic, Public Use Microdata Sets. Survey Methodology, 29, 181-189.
...
mira %>% pool(rule = "reiter2003", 
  ...
  summary() %>% tibble::column_to_rownames("term") %>% round(3)
```
Some adjustment to the pooling rules is neede to avoid p-inflation [^3].

[^3]: Raab, Gillian M, Beata Nowok, and Chris Dibben. 2018. “Practical Data Synthesis for Large Samples”. Journal of Privacy and Confidentiality 7 (3):67-97. [https://doi.org/10.29012/jpc.v7i3.407.](https://doi.org/10.29012/jpc.v7i3.407)
...
[^4]: Volker, T.B.; Vink, G. Anonymiced Shareable Data: Using mice to Create and Analyze Multiply Imputed Synthetic Datasets. Psych 2021, 3, 703-716. [https://doi.org/10.3390/psych3040045](https://doi.org/10.3390/psych3040045)
...
[^5]: Volker, T.B.; Vink, G. Anonymiced Shareable Data: Using mice to Create and Analyze Multiply Imputed Synthetic Datasets. Psych 2021, 3, 703-716. [https://doi.org/10.3390/psych3040045](https://doi.org/10.3390/psych3040045)
